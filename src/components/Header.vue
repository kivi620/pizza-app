    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="py-2" href="#">
              ...
              <ul class="navbar-nav">
                  <!-- 知识点1：<li><router-link tag="div" to="/" class="nav-link">主页</router-link></li>    <router-link>标签在浏览器中会默认渲染成<a>标签  增加了tag属性之后，会变成tag中的标签，而不是<a>标签 -->
                  <!-- 知识点2：<li><router-link :to="homeLink" class="nav-link">主页</router-link></li>          动态修改to中的内容 -->
